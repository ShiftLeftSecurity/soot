...
public final class AIidentityStatement extends PStatement
{
    ...
    public Object clone()
    {
        return new AIidentityStatement(
    ...
    {
        ((Analysis) sw).caseAIidentityStatement(this);
    }
