...
public interface Analysis extends Switch
{
    ...
    void caseARewrite(ARewrite node);
    ...
    void caseAPredFormula(APredFormula node);
    void caseAAxFormula(AAxFormula node);
    void caseAAuFormula(AAuFormula node);
    void caseAAwFormula(AAwFormula node);
    void caseAExFormula(AExFormula node);
    void caseAEuFormula(AEuFormula node);
    void caseAEwFormula(AEwFormula node);
    void caseAAndFormula(AAndFormula node);
    void caseAOrFormula(AOrFormula node);
    void caseANotFormula(ANotFormula node);
    ...
    void caseANothingStatement(ANothingStatement node);
    ...
    void caseTAlwaysNext(TAlwaysNext node);
    void caseTExistsNext(TExistsNext node);
    void caseTNext(TNext node);
    void caseTUntil(TUntil node);
    void caseTWuntil(TWuntil node);
    ...
    void caseTTransform(TTransform node);
