...
package soot.jimple.toolkits.ctl.parser.analysis;
...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void outAGroundReduction(AGroundReduction node)
    {
        defaultOut(node);
    }
    ...
    public void caseAGroundReduction(AGroundReduction node)
    {
        ...
        if(node.getRedBody() != null)
        {
            node.getRedBody().apply(this);
        }
        if(node.getRBrace() != null)
        {
            node.getRBrace().apply(this);
        }
        outAGroundReduction(node);
    }

    public void inAFormalsReduction(AFormalsReduction node)
    {
        defaultIn(node);
    }

    public void outAFormalsReduction(AFormalsReduction node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAFormalsReduction(AFormalsReduction node)
    {
        inAFormalsReduction(node);
        if(node.getRed() != null)
        {
            node.getRed().apply(this);
        }
        ...
        outAFormalsReduction(node);
    }

    public void inARedBody(ARedBody node)
    {
        defaultIn(node);
    }

    public void outARedBody(ARedBody node)
    {
        defaultOut(node);
    }

    @Override
    public void caseARedBody(ARedBody node)
    {
        inARedBody(node);
        {
        ...
        {
            List<PCondition> copy = new ArrayList<PCondition>(node.getCondition());
        ...
        {
            List<PRewrite> copy = new ArrayList<PRewrite>(node.getRewrite());
            for(PRewrite e : copy)
            {
                e.apply(this);
            }
    ...
    public void inARewrite(ARewrite node)
    {
        defaultIn(node);
    }

    public void outARewrite(ARewrite node)
    {
        defaultOut(node);
    }

    @Override
    public void caseARewrite(ARewrite node)
    {
        inARewrite(node);
        if(node.getTransform() != null)
        {
            node.getTransform().apply(this);
        }
        if(node.getIdentifier() != null)
        {
            node.getIdentifier().apply(this);
    ...
    public void inAPredFormula(APredFormula node)
    {
        defaultIn(node);
    }

    public void outAPredFormula(APredFormula node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAPredFormula(APredFormula node)
    {
        inAPredFormula(node);
        if(node.getIdentifier() != null)
        {
        ...
        outAPredFormula(node);
    }

    public void inAAxFormula(AAxFormula node)
    {
        defaultIn(node);
    }

    public void outAAxFormula(AAxFormula node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAAxFormula(AAxFormula node)
    {
        inAAxFormula(node);
        if(node.getAlwaysNext() != null)
        {
            node.getAlwaysNext().apply(this);
        }
        if(node.getFormula() != null)
        {
            node.getFormula().apply(this);
    ...
    public void inAAuFormula(AAuFormula node)
    {
        defaultIn(node);
    }

    public void outAAuFormula(AAuFormula node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAAuFormula(AAuFormula node)
    {
        inAAuFormula(node);
    ...
    public void inAAwFormula(AAwFormula node)
    {
        defaultIn(node);
    }

    public void outAAwFormula(AAwFormula node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAAwFormula(AAwFormula node)
    {
        inAAwFormula(node);
        if(node.getAlways() != null)
        {
        ...
        if(node.getWuntil() != null)
        {
            node.getWuntil().apply(this);
        }
        if(node.getR() != null)
        {
            node.getR().apply(this);
    ...
    public void inAExFormula(AExFormula node)
    {
        defaultIn(node);
    }

    public void outAExFormula(AExFormula node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAExFormula(AExFormula node)
    {
        inAExFormula(node);
        if(node.getExistsNext() != null)
        {
            node.getExistsNext().apply(this);
        }
        if(node.getFormula() != null)
        {
            node.getFormula().apply(this);
    ...
    public void inAEuFormula(AEuFormula node)
    {
        defaultIn(node);
    }

    public void outAEuFormula(AEuFormula node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAEuFormula(AEuFormula node)
    {
        inAEuFormula(node);
    ...
    public void inAEwFormula(AEwFormula node)
    {
        defaultIn(node);
    }

    public void outAEwFormula(AEwFormula node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAEwFormula(AEwFormula node)
    {
        inAEwFormula(node);
        if(node.getExists() != null)
        {
    ...
    public void inAAndFormula(AAndFormula node)
    {
        defaultIn(node);
    }
    ...
    @Override
    public void caseAAndFormula(AAndFormula node)
    {
        inAAndFormula(node);
        if(node.getLParen() != null)
        {
        ...
        if(node.getAndand() != null)
        {
            node.getAndand().apply(this);
        }
        if(node.getR() != null)
        {
            node.getR().apply(this);
    ...
    public void inAOrFormula(AOrFormula node)
    {
        defaultIn(node);
    }
    ...
    @Override
    public void caseAOrFormula(AOrFormula node)
    {
        inAOrFormula(node);
        if(node.getLParen() != null)
        {
        ...
        if(node.getOror() != null)
        {
            node.getOror().apply(this);
        }
        if(node.getR() != null)
        {
            node.getR().apply(this);
    ...
    public void inANotFormula(ANotFormula node)
    {
        defaultIn(node);
    }

    public void outANotFormula(ANotFormula node)
    {
        defaultOut(node);
    }

    @Override
    public void caseANotFormula(ANotFormula node)
    {
        inANotFormula(node);
        if(node.getNot() != null)
        {
    ...
    public void inANothingStatement(ANothingStatement node)
    {
        defaultIn(node);
    }

    public void outANothingStatement(ANothingStatement node)
    {
        defaultOut(node);
    }

    @Override
    public void caseANothingStatement(ANothingStatement node)
    {
        inANothingStatement(node);
