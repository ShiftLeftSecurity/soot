...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTAlwaysNext(@SuppressWarnings("unused") TAlwaysNext node)
    {
        this.index = 3;
    }

    @Override
    public void caseTExistsNext(@SuppressWarnings("unused") TExistsNext node)
    {
        this.index = 4;
    }
    ...
    @Override
    public void caseTWuntil(@SuppressWarnings("unused") TWuntil node)
    {
        this.index = 7;
    }
    ...
    @Override
    public void caseTTransform(@SuppressWarnings("unused") TTransform node)
    {
        this.index = 70;
    }
    ...
    @Override
    public void caseTAndand(@SuppressWarnings("unused") TAndand node)
    {
        this.index = 84;
    }
    ...
    @Override
    public void caseTOror(@SuppressWarnings("unused") TOror node)
    {
        this.index = 86;
    }
    ...
    @Override
    public void caseTPred(@SuppressWarnings("unused") TPred node)
    {
        this.index = 104;
    }

    @Override
    public void caseTRed(@SuppressWarnings("unused") TRed node)
    {
        this.index = 105;
    }
