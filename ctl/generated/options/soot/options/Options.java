...
public class Options extends OptionsBase {
        ...
        while( hasMoreOptions() ) {
            ...
            || option.equals( "tr" )
                ...
                if( tr.length() == 0 )
                    ...
                    G.v().out.println( "Duplicate values "+tr+" and "+value+" for option -"+option );
                    return false;
                }
            }
    ...
    public void set_tr( String setting ) { tr = setting; }
    private String tr = "";
    public List include() { 
        if( include == null )
            return java.util.Collections.EMPTY_LIST;
...
+padOpt(" -tr TRANS_FILE", "Reads CTL-FV based transformations from TRANS_FILE." )
...
+padOpt(" -subtract-gc", "Subtract gc from time" );
    ...
    public String getPhaseList() {
        ...
        +padVal("jop.ctl", "CTL-FV based code transformer")
    ...
    public String getPhaseHelp( String phaseName ) {
        ...
        if( phaseName.equals( "jop.ctl" ) )
            return "Phase "+phaseName+":\n"+
                "\nReads a file stated via the -tr command line option, and \napplies the transformations stated in that file. "
                +"\n\nRecognized options (with default values):\n"
                +padOpt( "enabled (true)", "" );
    ...
    public void warnForeignPhase( String phaseName ) {
        ...
        if( phaseName.equals( "jop.ctl" ) ) return;
    ...
    public void warnNonexistentPhase() {
        ...
        if( !PackManager.v().hasPhase( "jop.ctl" ) )
            G.v().out.println( "Warning: Options exist for non-existent phase jop.ctl" );
