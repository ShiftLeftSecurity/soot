...
public class BDDReachableMethods {
    ...
    private final jedd.Relation set =
      new jedd.Relation(new jedd.Domain[] { method.v(), ctxt.v() },
    ...
    private jedd.Relation toBDD(MethodOrMethodContext m) {
        return new jedd.Relation(new jedd.Domain[] { method.v(), ctxt.v() },
                                 new jedd.PhysicalDomain[] { V2.v(), T2.v() },
                                 jedd.Jedd.v().literal(new Object[] { m.method(), m.context() },
                                                       new jedd.Domain[] { method.v(), ctxt.v() },
                                                       new jedd.PhysicalDomain[] { V2.v(), T2.v() }));
    }
    ...
    private void addMethod(MethodOrMethodContext m) {
        final jedd.Relation bdd =
          new jedd.Relation(new jedd.Domain[] { method.v(), ctxt.v() },
                            new jedd.PhysicalDomain[] { V2.v(), T2.v() },
                            this.toBDD(m));
        this.addMethod(new jedd.Relation(new jedd.Domain[] { method.v(), ctxt.v() },
                                         new jedd.PhysicalDomain[] { V2.v(), T2.v() },
                                         bdd));
    }
    ...
    private void addMethod(final jedd.Relation m) {
        final jedd.Relation addToReachables =
          new jedd.Relation(new jedd.Domain[] { method.v(), ctxt.v() },
                            ...
                            jedd.Jedd.v().minus(jedd.Jedd.v().read(jedd.Jedd.v().replace(m,
                                                                                         new jedd.PhysicalDomain[] { V2.v() },
                                                                                         new jedd.PhysicalDomain[] { V1.v() })),
                                                jedd.Jedd.v().replace(this.set,
                                                                      new jedd.PhysicalDomain[] { T1.v() },
                                                                      new jedd.PhysicalDomain[] { T2.v() })));
        this.set.eqUnion(jedd.Jedd.v().replace(addToReachables,
                                               new jedd.PhysicalDomain[] { T2.v() },
                                               new jedd.PhysicalDomain[] { T1.v() }));
        this.reachables.add(new jedd.Relation(new jedd.Domain[] { method.v(), ctxt.v() },
                                              new jedd.PhysicalDomain[] { V1.v(), T1.v() },
    ...
    public void update() {
        while (true) {
            final jedd.Relation e =
              new jedd.Relation(new jedd.Domain[] { srcm.v(), srcc.v(), stmt.v(), tgtm.v(), tgtc.v(), kind.v() },
            ...
            e.eqIntersect(this.set);
            this.addMethod(new jedd.Relation(new jedd.Domain[] { method.v(), ctxt.v() },
                                             new jedd.PhysicalDomain[] { V2.v(), T2.v() },
                                             this.targets(new jedd.Relation(new jedd.Domain[] { srcc.v(), tgtm.v(), stmt.v(), srcm.v(), kind.v(), tgtc.v() },
        ...
        while (true) {
            ...
            final jedd.Relation e =
              new jedd.Relation(new jedd.Domain[] { srcm.v(), srcc.v(), stmt.v(), tgtm.v(), tgtc.v(), kind.v() },
                                new jedd.PhysicalDomain[] { V1.v(), T1.v(), ST.v(), V2.v(), T2.v(), H2.v() },
                                this.cg.edgesOutOf(new jedd.Relation(new jedd.Domain[] { srcm.v(), srcc.v() },
                                                                     new jedd.PhysicalDomain[] { V1.v(), T1.v() },
                                                                     m)));
            this.addMethod(new jedd.Relation(new jedd.Domain[] { method.v(), ctxt.v() },
                                             new jedd.PhysicalDomain[] { V2.v(), T2.v() },
    ...
    public boolean contains(MethodOrMethodContext m) {
        return !jedd.Jedd.v().equals(jedd.Jedd.v().read(jedd.Jedd.v().intersect(jedd.Jedd.v().read(jedd.Jedd.v().replace(this.set,
                                                                                                                         new jedd.PhysicalDomain[] { V1.v() },
                                                                                                                         new jedd.PhysicalDomain[] { V2.v() })),
                                                                                jedd.Jedd.v().replace(this.toBDD(m),
                                                                                                      new jedd.PhysicalDomain[] { T2.v() },
                                                                                                      new jedd.PhysicalDomain[] { T1.v() }))),
                                     jedd.Jedd.v().falseBDD());
    }
