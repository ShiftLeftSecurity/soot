...
public class BDDSideEffectAnalysis {
    ...
    final jedd.Relation ntread =
      new jedd.Relation(new jedd.Domain[] { method.v(), stmt.v(), fld.v(), obj.v() },
    ...
    private jedd.Relation addValue(Value v, SootMethod m, Stmt s) {
            ...
            if (v instanceof StaticFieldRef) {
                ...
                return new jedd.Relation(new jedd.Domain[] { method.v(), stmt.v(), fld.v(), obj.v() },
                                         ...
                                         jedd.Jedd.v().literal(new Object[] { m, s, sfr.getField(), null },
                                                               new jedd.Domain[] { method.v(), stmt.v(), fld.v(), obj.v() },
                                                               new jedd.PhysicalDomain[] { V2.v(), ST.v(), FD.v(), H1.v() }));
            } else
        ...
        return new jedd.Relation(new jedd.Domain[] {  }, new jedd.PhysicalDomain[] {  }, jedd.Jedd.v().falseBDD());
    }
    ...
    private void closure() {
        ...
        final jedd.Relation closecg =
          new jedd.Relation(new jedd.Domain[] { srcm.v(), stmt.v(), tgtm.v() },
        ...
        while (!jedd.Jedd.v().equals(jedd.Jedd.v().read(closecg),
                                     closecg.eqUnion(jedd.Jedd.v().compose(jedd.Jedd.v().read(jedd.Jedd.v().replace(closecg,
                                                                           ...
                                                                           new jedd.PhysicalDomain[] { V3.v() }))))
            ;
        this.read.eqUnion(jedd.Jedd.v().replace(jedd.Jedd.v().compose(jedd.Jedd.v().read(closecg),
                                                                      jedd.Jedd.v().project(this.ntread,
                                                                                            new jedd.PhysicalDomain[] { ST.v() }),
                                                                      new jedd.PhysicalDomain[] { V2.v() }),
                                                new jedd.PhysicalDomain[] { V1.v() },
                                                new jedd.PhysicalDomain[] { V2.v() }));
        this.write.eqUnion(jedd.Jedd.v().replace(jedd.Jedd.v().compose(jedd.Jedd.v().read(closecg),
    ...
    public void analyze() {
        ...
        for (Iterator mIt =
               new jedd.Relation(new jedd.Domain[] { tgtm.v() },
                                 new jedd.PhysicalDomain[] { V2.v() },
    ...
    private void output() {
        final jedd.Relation methods =
          new jedd.Relation(new jedd.Domain[] { method.v() },
                            new jedd.PhysicalDomain[] { V2.v() },
                            jedd.Jedd.v().falseBDD());
        ...
        System.out.println("Read sets:\n" +
                           new jedd.Relation(new jedd.Domain[] { method.v(), stmt.v(), fld.v(), obj.v() },
                                             ...
                                             jedd.Jedd.v().join(jedd.Jedd.v().read(this.read),
                                                                methods,
                                                                new jedd.PhysicalDomain[] { V2.v() })).toString());
