...
public class BDDContextCallGraphBuilder extends AbsContextCallGraphBuilder {
    ...
    public void update() {
        final jedd.internal.RelationContainer methods =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ot-2-jedd/src/soot/jimple/paddle/BDDContextCallGraphBuilder." +
                                               "jedd:35,23-30"),
                                              in.get());
        Rsrcc_srcm_stmt_kind_tgtc_tgtm edges =
          cicg.edgesOutOf(new Rctxt_methodBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { method.v(), ctxt.v() },
                                                                                  ...
                                                                                  ("new soot.jimple.paddle.queue.Rctxt_methodBDD(...) at /home/o" +
                                                                                   "lhotak/soot-2-jedd/src/soot/jimple/paddle/BDDContextCallGrap" +
                                                                                   "hBuilder.jedd:38,12-15"),
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), srcm.v(), tgtc.v(), kind.v(), stmt.v(), srcc.v() },
                                                    new jedd.PhysicalDomain[] { T2.v(), T1.v(), V2.v(), FD.v(), ST.v(), V1.v() },
                                                    ("out.add(jedd.internal.Jedd.v().join(jedd.internal.Jedd.v().r" +
                                                     ...
                                                     "at /home/olhotak/soot-2-jedd/src/soot/jimple/paddle/BDDConte" +
                                                     "xtCallGraphBuilder.jedd:41,8-11"),
