    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { local.v(), srcm.v(), stmt.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.local:soot.jimple.paddle.bddd" +
                                               ...
                                               "dd.v().falseBDD(); at /home/olhotak/soot-2-jedd/src/soot/jim" +
                                               "ple/paddle/queue/Rlocal_srcm_stmt_tgtmIter.jedd:46,46-49"),
        ...
        return new jedd.internal.RelationContainer(new Attribute[] { tgtm.v(), srcm.v(), local.v(), stmt.v() },
                                                   ...
                                                   ("return ret; at /home/olhotak/soot-2-jedd/src/soot/jimple/pad" +
                                                    "dle/queue/Rlocal_srcm_stmt_tgtmIter.jedd:50,8-14"),
                                                   ret);
    }
