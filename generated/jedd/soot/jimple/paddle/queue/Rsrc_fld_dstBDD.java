    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.src:soot.jimple.paddl" +
                                           ...
                                           "oot.jimple.paddle.bdddomains.V2> bdd at /home/olhotak/soot-2" +
                                           "-jedd/src/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:31,1" +
                                           "2-36"));
    ...
    public Rsrc_fld_dstBDD(final jedd.internal.RelationContainer bdd) {
        ...
        add(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), src.v() },
                                                ...
                                                ("add(bdd) at /home/olhotak/soot-2-jedd/src/soot/jimple/paddle" +
                                                 "/queue/Rsrc_fld_dstBDD.jedd:33,69-72"),
                                                bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), src.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "2-jedd/src/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:45," +
                                                           "25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.src:soot.jimple.paddle.bdddom" +
                                               ...
                                               "le.paddle.bdddomains.V2> ret = bdd; at /home/olhotak/soot-2-" +
                                               "jedd/src/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:55,33" +
                                               "-36"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
