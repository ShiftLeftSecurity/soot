    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { srcm.v(), stmt.v(), kind.v(), tgtm.v(), src.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcm:soot.jimple.padd" +
                                           ...
                                           " bdd at /tmp/fixing-paddle/src/soot/jimple/paddle/queue/Rsrc" +
                                           "m_stmt_kind_tgtm_src_dstBDD.jedd:31,12-64"));
    
    void add(final jedd.internal.RelationContainer tuple) { bdd.eqUnion(tuple); }
    
    public Rsrcm_stmt_kind_tgtm_src_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { dst.v(), srcm.v(), src.v(), tgtm.v(), stmt.v(), kind.v() },
                                                new PhysicalDomain[] { V2.v(), MS.v(), V1.v(), MT.v(), ST.v(), KD.v() },
                                                ("add(bdd) at /tmp/fixing-paddle/src/soot/jimple/paddle/queue/" +
                                                 "Rsrcm_stmt_kind_tgtm_src_dstBDD.jedd:33,130-133"),
                                                bdd));
    }
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { dst.v(), srcm.v(), src.v(), tgtm.v(), stmt.v(), kind.v() },
                                                          new PhysicalDomain[] { V2.v(), MS.v(), V1.v(), MT.v(), ST.v(), KD.v() },
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { srcm.v(), stmt.v(), kind.v(), tgtm.v(), src.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcm:soot.jimple.paddle.bdddo" +
                                               ...
                                               "dd; at /tmp/fixing-paddle/src/soot/jimple/paddle/queue/Rsrcm" +
                                               "_stmt_kind_tgtm_src_dstBDD.jedd:55,61-64"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { dst.v(), srcm.v(), src.v(), tgtm.v(), stmt.v(), kind.v() },
                                                   new PhysicalDomain[] { V2.v(), MS.v(), V1.v(), MT.v(), ST.v(), KD.v() },
                                                   ("return ret; at /tmp/fixing-paddle/src/soot/jimple/paddle/que" +
                                                    "ue/Rsrcm_stmt_kind_tgtm_src_dstBDD.jedd:57,8-14"),
                                                   ret);
    }
