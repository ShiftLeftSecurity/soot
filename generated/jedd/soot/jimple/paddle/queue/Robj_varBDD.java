    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.obj:soot.jimple.paddl" +
                                           ...
                                           "le.paddle.bdddomains.V1> bdd at /tmp/fixing-paddle/src/soot/" +
                                           "jimple/paddle/queue/Robj_varBDD.jedd:31,12-28"));
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /tmp/fixing-paddle/" +
                                                           "src/soot/jimple/paddle/queue/Robj_varBDD.jedd:45,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.obj:soot.jimple.paddle.bdddom" +
                                               ...
                                               "e.bdddomains.V1> ret = bdd; at /tmp/fixing-paddle/src/soot/j" +
                                               "imple/paddle/queue/Robj_varBDD.jedd:55,25-28"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
