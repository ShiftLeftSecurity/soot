...
public final class Qsrcc_src_dstc_dstBDD extends Qsrcc_src_dstc_dst {
    ...
    public void add(final jedd.internal.RelationContainer in) {
        ...
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { dst.v(), src.v(), srcc.v(), dstc.v() },
                                                           new PhysicalDomain[] { V2.v(), V1.v(), C1.v(), C2.v() },
                                                           ("reader.add(in) at /tmp/fixing-paddle/src/soot/jimple/paddle/" +
                                                            "queue/Qsrcc_src_dstc_dstBDD.jedd:40,12-18"),
                                                           in));
        }
    }
