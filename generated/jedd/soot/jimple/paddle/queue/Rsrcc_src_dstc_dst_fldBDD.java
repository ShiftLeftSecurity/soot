...
public final class Rsrcc_src_dstc_dst_fldBDD extends Rsrcc_src_dstc_dst_fld {
    ...
    public Rsrcc_src_dstc_dst_fldBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), src.v(), dstc.v(), srcc.v(), dst.v() },
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { fld.v(), src.v(), dstc.v(), srcc.v(), dst.v() },
                                                          new PhysicalDomain[] { FD.v(), V1.v(), C2.v(), C1.v(), V2.v() },
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), dstc.v(), dst.v(), fld.v() },
                                              ...
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { fld.v(), src.v(), dstc.v(), srcc.v(), dst.v() },
                                                   new PhysicalDomain[] { FD.v(), V1.v(), C2.v(), C1.v(), V2.v() },
