    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { var.v(), type.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.var:soot.jimple.paddl" +
                                           ...
                                           "ple.paddle.bdddomains.T1> bdd at /tmp/fixing-paddle/src/soot" +
                                           "/jimple/paddle/queue/Rvar_typeBDD.jedd:31,12-29"));
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { var.v(), type.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /tmp/fixing-paddle/" +
                                                           "src/soot/jimple/paddle/queue/Rvar_typeBDD.jedd:45,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { var.v(), type.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.var:soot.jimple.paddle.bdddom" +
                                               ...
                                               "le.bdddomains.T1> ret = bdd; at /tmp/fixing-paddle/src/soot/" +
                                               "jimple/paddle/queue/Rvar_typeBDD.jedd:55,26-29"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
