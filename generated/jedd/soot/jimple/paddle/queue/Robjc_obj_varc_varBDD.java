...
public final class Robjc_obj_varc_varBDD extends Robjc_obj_varc_var {
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { objc.v(), obj.v(), varc.v(), var.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.objc:soot.jimple.padd" +
                                           ...
                                           "ains.var:soot.jimple.paddle.bdddomains.V1> bdd at /tmp/fixin" +
                                           "g-paddle/src/soot/jimple/paddle/queue/Robjc_obj_varc_varBDD." +
                                           "jedd:31,12-46"));
    ...
    public Robjc_obj_varc_varBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v(), varc.v(), objc.v() },
                                                new PhysicalDomain[] { H1.v(), V1.v(), C1.v(), C2.v() },
                                                ("add(bdd) at /tmp/fixing-paddle/src/soot/jimple/paddle/queue/" +
                                                 "Robjc_obj_varc_varBDD.jedd:33,102-105"),
                                                bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v(), varc.v(), objc.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /tmp/fixing-paddle/" +
                                                           "src/soot/jimple/paddle/queue/Robjc_obj_varc_varBDD.jedd:45,2" +
                                                           "5-28"),
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { objc.v(), obj.v(), varc.v(), var.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.objc:soot.jimple.paddle.bdddo" +
                                               ...
                                               ":soot.jimple.paddle.bdddomains.V1> ret = bdd; at /tmp/fixing" +
                                               "-paddle/src/soot/jimple/paddle/queue/Robjc_obj_varc_varBDD.j" +
                                               "edd:55,43-46"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v(), varc.v(), objc.v() },
                                                   ...
                                                   ("return ret; at /tmp/fixing-paddle/src/soot/jimple/paddle/que" +
                                                    "ue/Robjc_obj_varc_varBDD.jedd:57,8-14"),
                                                   ret);
    }
