...
public class BDDCallGraph extends AbsCallGraph {
    private final jedd.internal.RelationContainer edges =
      new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc, soot.jimple.pad" +
                                           ...
                                           "ns.tgtc, soot.jimple.paddle.bdddomains.tgtm> edges at /tmp/f" +
                                           "ixing-paddle/src/soot/jimple/paddle/BDDCallGraph.jedd:30,12-" +
                                           "48"));
        ...
        final jedd.internal.RelationContainer newEdges =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ges = in.get(); at /tmp/fixing-paddle/src/soot/jimple/paddle" +
                                               "/BDDCallGraph.jedd:35,45-53"),
                                              in.get());
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(Rctxt_method methods) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { stmt.v(), tgtm.v(), srcm.v(), kind.v(), srcc.v(), tgtc.v() },
                                                                                         new jedd.PhysicalDomain[] { ST.v(), MT.v(), MS.v(), KD.v(), C1.v(), C2.v() },
    ...
    public int size() {
        return (int)
                 new jedd.internal.RelationContainer(new jedd.Attribute[] { stmt.v(), tgtm.v(), kind.v(), srcm.v(), srcc.v(), tgtc.v() },
                                                     new jedd.PhysicalDomain[] { ST.v(), MT.v(), KD.v(), MS.v(), C1.v(), C2.v() },
                                                     ("edges.size() at /tmp/fixing-paddle/src/soot/jimple/paddle/BD" +
                                                      "DCallGraph.jedd:57,21-26"),
                                                     edges).size();
    }
}
