...
public class PropBDD extends AbsPropagator {
    ...
    protected void outputPt(final jedd.internal.RelationContainer pt) {
        ...
        if (jedd.internal.Jedd.v().equals(jedd.internal.Jedd.v().read(toOutput), jedd.internal.Jedd.v().falseBDD()))
            return;
        ptout.add(new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v(), varc.v(), objc.v() },
                                                      new PhysicalDomain[] { H1.v(), V1.v(), C1.v(), C2.v() },
    ...
    protected jedd.internal.RelationContainer propStore(final jedd.internal.RelationContainer pt,
        ...
        return new jedd.internal.RelationContainer(new Attribute[] { obj.v(), fld.v(), objc.v(), basec.v(), base.v() },
                                                   new PhysicalDomain[] { H2.v(), FD.v(), C2.v(), C1.v(), H1.v() },
    ...
    public void update() {
        while (true) {
            ...
            pt.eqUnion(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().intersect(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(propSimple(new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v(), varc.v(), objc.v() },
                                                                                                                                                                                                 new PhysicalDomain[] { H1.v(), V2.v(), C3.v(), C2.v() },
            ...
            fieldPt.eqUnion(propStore(new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v(), varc.v(), objc.v() },
                                      ...
                                      new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v(), varc.v(), objc.v() },
                                                                          ...
                                                                          ("propStore(jedd.internal.Jedd.v().replace(pt, new jedd.Physic" +
                                                                           ...
                                                                           "pBDD.jedd:112,23-32"),
                                                                          pt)));
            pt.eqUnion(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().intersect(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(propLoad(new jedd.internal.RelationContainer(new Attribute[] { basec.v(), obj.v(), base.v(), fld.v(), objc.v() },
                                                                                       ...
                                                                                       jedd.internal.Jedd.v().replace(typeFilter(),
                                                                                                                      ...
                                                                                                                      new PhysicalDomain[] { C2.v(), C3.v(), H2.v() })),
                                                      new PhysicalDomain[] { H2.v(), V1.v() },
                                                      new PhysicalDomain[] { H1.v(), V2.v() }));
            outputPt(new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v(), varc.v(), objc.v() },
                                                         new PhysicalDomain[] { H1.v(), V1.v(), C1.v(), C2.v() },
