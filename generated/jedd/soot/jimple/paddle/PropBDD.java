...
public class PropBDD extends AbsPropagator {
    ...
    protected jedd.internal.RelationContainer typeFilter() {
        ...
        return new jedd.internal.RelationContainer(new Attribute[] { var.v(), obj.v(), varc.v(), objc.v() },
                                                   new PhysicalDomain[] { V1.v(), H1.v(), C3.v(), C2.v() },
          ...
          new jedd.internal.RelationContainer(new Attribute[] { objc.v(), obj.v(), varc.v(), var.v(), fld.v() },
                                              ...
                                              jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(store),
                                                                             jedd.internal.Jedd.v().replace(pt,
                                                                                                            ...
                                                                                                            new PhysicalDomain[] { C3.v() }),
                                                                             new PhysicalDomain[] { C1.v(), V1.v() }));
        return new jedd.internal.RelationContainer(new Attribute[] { fld.v(), obj.v(), objc.v(), base.v(), basec.v() },
                                                   new PhysicalDomain[] { FD.v(), H2.v(), C2.v(), H1.v(), C1.v() },
    ...
    public void update() {
        while (true) {
            ...
            pt.eqUnion(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().intersect(jedd.internal.Jedd.v().read(propSimple(new jedd.internal.RelationContainer(new Attribute[] { var.v(), obj.v(), objc.v(), varc.v() },
                                                                                                                                                                  new PhysicalDomain[] { V1.v(), H1.v(), C2.v(), C1.v() },
                                                                                                                                                                  ("propSimple(jedd.internal.Jedd.v().replace(pt, new jedd.Physi" +
                                                                                                                                                                   ...
                                                                                                                                                                   "main[...], new jedd.PhysicalDomain[...])) at /tmp/fixing-pad" +
                                                                                                                                                                   "dle/src/soot/jimple/paddle/PropBDD.jedd:109,18-28"),
                                                                                                                                                                  jedd.internal.Jedd.v().replace(pt,
                                                                                                                                                                                                 new PhysicalDomain[] { H2.v() },
                                                                                                                                                                                                 new PhysicalDomain[] { H1.v() })),
            ...
            fieldPt.eqUnion(propStore(new jedd.internal.RelationContainer(new Attribute[] { var.v(), obj.v(), objc.v(), varc.v() },
                                      ...
                                      new jedd.internal.RelationContainer(new Attribute[] { var.v(), obj.v(), objc.v(), varc.v() },
                                                                          ...
                                                                          jedd.internal.Jedd.v().replace(pt,
                                                                                                         new PhysicalDomain[] { H2.v() },
                                                                                                         new PhysicalDomain[] { H1.v() }))));
            pt.eqUnion(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().intersect(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(propLoad(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), base.v(), obj.v(), objc.v(), basec.v() },
