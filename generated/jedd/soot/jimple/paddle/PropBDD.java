...
public class PropBDD extends AbsPropagator {
    ...
    final jedd.internal.RelationContainer fieldPt =
      new jedd.internal.RelationContainer(new Attribute[] { basec.v(), base.v(), fld.v(), objc.v(), obj.v() },
                                          new PhysicalDomain[] { C1.v(), H2.v(), FD.v(), C2.v(), H1.v() },
    ...
    protected jedd.internal.RelationContainer typeFilter() {
        ...
        return new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v(), objc.v(), varc.v() },
                                                   new PhysicalDomain[] { H2.v(), V2.v(), C2.v(), C3.v() },
                                                   ("return jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v()" +
                                                    ...
                                                    ".]); at /tmp/fixing-paddle/src/soot/jimple/paddle/PropBDD.je" +
                                                    "dd:44,8-14"),
    ...
    public void update() {
        while (true) {
            ...
            pt.eqUnion(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().intersect(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(propLoad(new jedd.internal.RelationContainer(new Attribute[] { obj.v(), objc.v(), fld.v(), basec.v(), base.v() },
                                                                                                                                                                                               new PhysicalDomain[] { H1.v(), C2.v(), FD.v(), C1.v(), H2.v() },
                                                                                                                                                                                               ("propLoad(fieldPt, pag.allLoad().get(), pt) at /tmp/fixing-pa" +
                                                                                                                                                                                                "ddle/src/soot/jimple/paddle/PropBDD.jedd:113,18-26"),
                                                                                                                                                                                               fieldPt),
