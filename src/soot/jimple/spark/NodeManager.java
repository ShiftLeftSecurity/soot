...
public class NodeManager {
    ...
    public AllocNode makeAllocNode( Object newExpr, Type type, SootMethod m ) {
        if( SparkScene.v().options().types_for_sites() || SparkScene.v().options().vta() ) newExpr = type;
    ...
    public AllocNode makeStringConstantNode( String s ) {
        if( SparkScene.v().options().types_for_sites() || SparkScene.v().options().vta() )
