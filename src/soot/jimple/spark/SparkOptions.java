...
*********************************************************************/
    ...
    public void propagator( Switch_propagator sw ) {
        ...
        else throw new RuntimeException( "Invalid value of option propagator" );
    }
    ...
    public void setImpl( Switch_setImpl sw ) {
        ...
        else throw new RuntimeException( "Invalid value of option setImpl" );
    }
    ...
    public void doubleSetOld( Switch_doubleSetOld sw ) {
        ...
        else throw new RuntimeException( "Invalid value of option doubleSetOld" );
    }
    ...
    public void doubleSetNew( Switch_doubleSetNew sw ) {
        ...
        else throw new RuntimeException( "Invalid value of option doubleSetNew" );
    }
...
*********************************************************************/
    ...
    public static String getDeclaredOptions() {
        return
        " verbose ignoreTypesEntirely parmsAsFields returnsAsFields collapseObjects typesForSites mergeStringBuffer simulateNatives simpleEdgesBidirectional onFlyCallGraph collapseEBBs collapseSCCs ignoreTypesForSCCs propagator setImpl doubleSetOld doubleSetNew dumpHTML dumpPAG topoSort dumpTypes dumpAnswer";
    }
    public static String getDefaultOptions() {
        return
        " verbose:true ignoreTypesEntirely:false parmsAsFields:false returnsAsFields:false collapseObjects:false typesForSites:false mergeStringBuffer:true simulateNatives:false simpleEdgesBidirectional:false onFlyCallGraph:false collapseEBBs:true collapseSCCs:true ignoreTypesForSCCs:false propagator:worklist setImpl:double doubleSetOld:hybrid doubleSetNew:hybrid dumpHTML:false dumpPAG:false topoSort:false dumpTypes:true dumpAnswer:false";
    }
