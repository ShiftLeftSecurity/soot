...
public class DoublePointsToSet extends PointsToSetInternal {
    public DoublePointsToSet( Type type ) {
        super( type );
        newSet = SparkScene.v().newSetFactory.newSet( type );
        oldSet = SparkScene.v().oldSetFactory.newSet( type );
    }
    ...
    public void mergeWith( PointsToSetInternal other ) {
        ...
        final PointsToSetInternal newNewSet = SparkScene.v().newSetFactory.newSet( type );
        final PointsToSetInternal newOldSet = SparkScene.v().oldSetFactory.newSet( type );
    ...
    public static P2SetFactory getFactory( P2SetFactory newFactory,
        ...
        SparkScene.v().newSetFactory = newFactory;
        SparkScene.v().oldSetFactory = oldFactory;
