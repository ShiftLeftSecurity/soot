...
import soot.*;
import soot.jimple.spark.PointsToSetInternal;
...
public class FieldRefNode extends Node {
    ...
    public SparkField field() { return field; }
    ...
    FieldRefNode( VarNode base, SparkField field ) {
	super( null );
	if( field == null ) throw new RuntimeException( "null field" );
	this.base = base;
	this.field = field;
	base.addField( this, field );
        SparkNumberers.v().fieldRefNodeNumberer().add( this );
    }
