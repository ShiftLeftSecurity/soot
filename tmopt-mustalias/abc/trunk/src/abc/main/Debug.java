...
public class Debug {
    ...
    public boolean tmShadowStatistics = true; //give statistics about how many shadows existed/were disabled
    public boolean tmShadowDump = false; 		//dump disabled and remaining shadows
    public boolean tmShadowGroupDump = true; 		//dump complete and consistent shadow groups after flow-insensitive stage
    public boolean useMinimizedAutomaton = true;         //uses for each method a minimized DFA instead of
    ...
    public boolean noCallGraphAbstraction = false;
	public boolean skipLoopOpt = false;			    //apply skip-loop optimization for first non-initial states
