...
public class Main {
    ...
    public static void reset() {
		...
		abc.tm.weaving.matching.TMStateMachine.reset();
    ...
    public static void main(String[] args) {
        try {
            ...
            main.run();
            //explicitly exit so that other threads possibly running are aborted
            System.exit(0);
    ...
    public void parseArgs(String[] argArray) throws IllegalArgumentException, CompilerAbortedException {
        ...
        { 
            ...
            { String debug_no_debug = args.top();
                ...
                try {
                    Field f = abc.main.Debug.v().getClass().getField(debug_name);
    ...
    public void loadJars() throws CompilerFailedException {
        ...
        while (jari.hasNext()) {
            ...
            if(!new File(jar).exists()) {
            	System.err.println("WARNING: injar '"+jar+"' not found.");
            }
        ...
        while (jari.hasNext()) {
            String jar = (String)jari.next();
            if(!new File(jar).exists()) {
            	System.err.println("WARNING: inpath element '"+jar+"' not found.");
            }
