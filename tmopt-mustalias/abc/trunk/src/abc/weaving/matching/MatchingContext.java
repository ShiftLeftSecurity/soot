...
public class MatchingContext {
    ...
    /**
     * Returns the statement associated with the contained ShadowMatch, or
     * <code>null</code> if there is no such statement.
     */
    public Stmt getStatement() {
    	if(getShadowMatch() instanceof StmtShadowMatch) {
			StmtShadowMatch match = (StmtShadowMatch) getShadowMatch();
    		return match.getStmt();
    	}
    	return null; 
    }
}
