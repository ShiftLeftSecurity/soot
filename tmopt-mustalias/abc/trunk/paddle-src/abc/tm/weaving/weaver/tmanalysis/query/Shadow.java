...
public class Shadow {
	...
	public static Set allShadowsForTag(MatchingTMSymbolTag tag, SootMethod container) {
	...
	public static Set allShadowsForHost(Host h, SootMethod container) {
		if(h.hasTag(MatchingTMSymbolTag.NAME)) {
			MatchingTMSymbolTag tag = (MatchingTMSymbolTag) h.getTag(MatchingTMSymbolTag.NAME);
			return allShadowsForTag(tag, container);
		} else {
			return Collections.EMPTY_SET; 
		}
	}

	public static Set allShadowsForHostAndTM(Host h, SootMethod container, TraceMatch tm) {
		Set result = new HashSet();
		Set allShadowsForHost = allShadowsForHost(h, container);
	...
	public void importVariableMapping(Map mapping, SootMethod container)  {
