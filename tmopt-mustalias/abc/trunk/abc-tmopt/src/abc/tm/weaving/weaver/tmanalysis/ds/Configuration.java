...
public class Configuration implements Cloneable {
	 ...
	 */
	public Configuration(TMFlowAnalysis flowAnalysis,TMStateMachine sm, State additionalInitialState) {
		...
		Iterator<State> stateIter = sm.getStateIterator();
	...
	public Configuration(IntraProceduralTMFlowAnalysis flowAnalysis, TMStateMachine sm) {
		this(flowAnalysis, sm, null);
	}
